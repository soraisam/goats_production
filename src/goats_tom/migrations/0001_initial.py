    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_function_definition', models.TextField(editable=False)),
                ('function_definition', models.TextField(blank=True, help_text='Revised function definition by the user.', null=True)),
            ],
        ),
        migrations.CreateModel(
            name='UserKey',
        ...
        migrations.AddField(
            ...
            name='dragons_run',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='recipes', to='goats_tom.dragonsrun'),
        ),
        migrations.CreateModel(
            name='DRAGONSFile',
            fields=[
