    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('created', 'Created'), ('queued', 'Queued'), ('initializing', 'Initializing'), ('running', 'Running'), ('done', 'Done'), ('error', 'Error')], default='created', max_length=13)),
        ...
        migrations.AddField(
            ...
            name='dragons_run',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipes', to='goats_tom.dragonsrun'),
        ),
        migrations.CreateModel(
            name='DRAGONSFile',
            fields=[
