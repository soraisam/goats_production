...
class GOATSANTARESBrokerForm(GenericQueryForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        firefox_extension_url = "https://addons.mozilla.org/en-US/firefox/addon/antares2goats/"
            ...
            Div(
                ...
                Div(
                    HTML(f'''
                        ...
                        style="display: inline-block; max-height: 50px; margin-right: 1.5%;
                        filter: grayscale(100%);"/>
                        <img src="{safari_img_url}" alt="Safari Extension Store" class="img-fluid"
                        style="display: inline-block; max-height: 50px; margin-right: 1.5%;
                        filter: grayscale(100%);"/>
